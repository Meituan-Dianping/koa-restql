...
const loadModelRoutes = (router, method, model, name, options) => {
  ...
  Object.keys(associations).forEach(key => {
    ...
    let association     = associations[key]
      ...
      , loaderPath      = loader.model.association
      , loader;

    loaderPath = isSingular ? loaderPath.singular : loaderPath.plural;
    loader = loaderPath[associationType][method] || loaderPath[method];
