...
const createHasOneAssociation = (model, association) => {
  return function * (next) {
    ...
    if (data[as]) {
      ...
      try {
        ...
        data =
          yield data[as].update(this.request.body)
      ...
      data = 
        yield _create.apply(this, association.target, this.request.body) 
...
module.exports.createHasOneAssociation = createHasOneAssociation
